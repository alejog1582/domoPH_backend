...
@section('title', 'Crear Comunicación de Cobranza - Administrador')

@section('content')
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Crear Comunicación de Cobranza</h1>
            <p class="mt-2 text-sm text-gray-600">Configure una nueva comunicación automatizada de cobranza</p>
        </div>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.comunicaciones-cobranza.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="number" name="dia_envio_mes" id="dia_envio_mes" value="{{ old('dia_envio_mes') }}" required
                    min="1" max="31"
        ...
        <div class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="dias_mora_desde" id="dias_mora_desde" value="{{ old('dias_mora_desde', 0) }}" required
                        min="0"
                ...
                <div>
                    ...
                    <input type="number" name="dias_mora_hasta" id="dias_mora_hasta" value="{{ old('dias_mora_hasta') }}"
                        min="0"
        ...
        <div class="mb-4" id="mensaje-email-container">
            ...
            <textarea name="mensaje_email" id="mensaje_email" rows="10"
                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('mensaje_email') border-red-500 @enderror">{{ old('mensaje_email') }}</textarea>
            @error('mensaje_email')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4" id="mensaje-whatsapp-container">
            ...
            <textarea name="mensaje_whatsapp" id="mensaje_whatsapp" rows="10"
                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('mensaje_whatsapp') border-red-500 @enderror">{{ old('mensaje_whatsapp') }}</textarea>
        ...
        <div class="flex items-center justify-end gap-3 mt-6">
            ...
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                <i class="fas fa-save mr-2"></i>Guardar Comunicación
            </button>
        </div>
    </form>
</div>
