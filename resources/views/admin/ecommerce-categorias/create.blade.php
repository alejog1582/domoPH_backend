...
@section('title', 'Crear Categoría Ecommerce - Administrador')

@section('content')
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Crear Categoría Ecommerce</h1>
            <p class="mt-2 text-sm text-gray-600">Registra una nueva categoría para las publicaciones</p>
        </div>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.ecommerce-categorias.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input 
                    ...
                    placeholder="Ej: shopping-bag (sin fa- ni fas fa-)"
                >
