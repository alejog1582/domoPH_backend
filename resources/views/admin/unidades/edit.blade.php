...
@section('title', 'Editar Unidad - Administrador')
...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Modifica la información de la unidad</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input 
                    ...
                    id="bloque" 
                    name="bloque" 
                    value="{{ old('bloque', $unidad->bloque) }}" 
            ...
            <div>
                ...
                >
                    ...
                    <option value="apartamento" {{ old('tipo', $unidad->tipo) == 'apartamento' ? 'selected' : '' }}>Apartamento</option>
                    <option value="casa" {{ old('tipo', $unidad->tipo) == 'casa' ? 'selected' : '' }}>Casa</option>
                    <option value="local" {{ old('tipo', $unidad->tipo) == 'local' ? 'selected' : '' }}>Local</option>
                    <option value="parqueadero" {{ old('tipo', $unidad->tipo) == 'parqueadero' ? 'selected' : '' }}>Parqueadero</option>
                    <option value="bodega" {{ old('tipo', $unidad->tipo) == 'bodega' ? 'selected' : '' }}>Bodega</option>
            ...
            <div>
                ...
                <input 
                    ...
                    id="area_m2" 
                    name="area_m2" 
                    value="{{ old('area_m2', $unidad->area_m2) }}" 
                    step="0.01"
                    min="0"
            ...
            <div>
                ...
                <input 
                    ...
                    id="coeficiente" 
                    name="coeficiente" 
                    value="{{ old('coeficiente', $unidad->coeficiente) }}" 
                    min="0"
            ...
            <div>
                ...
                <input 
                    ...
                    id="habitaciones" 
                    name="habitaciones" 
                    value="{{ old('habitaciones', $unidad->habitaciones) }}" 
                    min="0"
            ...
            <div>
                ...
                >
                    ...
                    <option value="desocupada" {{ old('estado', $unidad->estado) == 'desocupada' ? 'selected' : '' }}>Desocupada</option>
                    <option value="en_construccion" {{ old('estado', $unidad->estado) == 'en_construccion' ? 'selected' : '' }}>En Construcción</option>
