...
@section('title', 'Crear Depósito - Administrador')

@section('content')
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Crear Depósito</h1>
            <p class="mt-2 text-sm text-gray-600">Registra un nuevo depósito</p>
        </div>
