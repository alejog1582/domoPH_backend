...
@section('title', 'Editar Residente - Administrador')
...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Modifica la información del residente</p>
        </div>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.residentes.update', $residente->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input 
                    ...
                    id="nombre" 
                    name="nombre" 
                    value="{{ old('nombre', $residente->user->nombre ?? '') }}" 
                    required
            ...
            <div>
                ...
                <input 
                    ...
                    id="email" 
                    name="email" 
                    value="{{ old('email', $residente->user->email ?? '') }}" 
                    required
            ...
            <div>
                ...
                <input 
                    ...
                    value="{{ old('documento_identidad', $residente->user->documento_identidad ?? '') }}" 
            ...
            <div>
                ...
                <input 
                    ...
                    id="telefono" 
                    name="telefono" 
                    value="{{ old('telefono', $residente->user->telefono ?? '') }}" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                >
                    ...
                    @foreach($unidades as $unidad)
                        ...
                        @endphp
                        <option value="{{ $unidad->id }}" {{ old('unidad_id', $residente->unidad_id) == $unidad->id ? 'selected' : '' }}>
                            {{ $unidadLabel }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    <option value="propietario" {{ old('tipo_relacion', $residente->tipo_relacion) == 'propietario' ? 'selected' : '' }}>Propietario</option>
                    <option value="arrendatario" {{ old('tipo_relacion', $residente->tipo_relacion) == 'arrendatario' ? 'selected' : '' }}>Arrendatario</option>
                    <option value="residente_temporal" {{ old('tipo_relacion', $residente->tipo_relacion) == 'residente_temporal' ? 'selected' : '' }}>Residente Temporal</option>
                    <option value="otro" {{ old('tipo_relacion', $residente->tipo_relacion) == 'otro' ? 'selected' : '' }}>Otro</option>
                </select>
                @error('tipo_relacion')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input 
                    ...
                    id="fecha_inicio" 
                    name="fecha_inicio" 
                    value="{{ old('fecha_inicio', $residente->fecha_inicio ? $residente->fecha_inicio->format('Y-m-d') : '') }}" 
            ...
            <div>
                ...
                <input 
                    ...
                    id="fecha_fin" 
                    name="fecha_fin" 
                    value="{{ old('fecha_fin', $residente->fecha_fin ? $residente->fecha_fin->format('Y-m-d') : '') }}" 
            ...
            <div>
                <label class="flex items-center">
                    <input 
                        ...
                        name="es_principal" 
                        value="1"
                        {{ old('es_principal', $residente->es_principal) ? 'checked' : '' }}
            ...
            <div>
                <label class="flex items-center">
                    <input 
                        ...
                        value="1"
                        {{ old('recibe_notificaciones', $residente->recibe_notificaciones ?? true) ? 'checked' : '' }}
                        class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                    >
            ...
            <div class="md:col-span-2">
                ...
                >{{ old('observaciones', $residente->observaciones) }}</textarea>
                @error('observaciones')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
