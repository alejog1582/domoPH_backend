...
@section('title', 'Editar Usuario Admin - Administrador')

@section('content')
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Editar Usuario Admin</h1>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.usuarios-admin.update', $usuarioAdmin->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input 
                    ...
                    id="nombre" 
                    name="nombre" 
                    value="{{ old('nombre', $usuarioAdmin->nombre) }}" 
                    required
            ...
            <div>
                ...
                <input 
                    ...
                    id="email" 
                    name="email" 
                    value="{{ old('email', $usuarioAdmin->email) }}" 
                    required
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                    Nueva Contraseña <span class="text-gray-500 text-xs">(dejar en blanco para no cambiar)</span>
                </label>
                <input 
                    type="password" 
                    id="password" 
            ...
            <div>
                ...
                <input 
                    ...
                    value="{{ old('documento_identidad', $usuarioAdmin->documento_identidad) }}" 
            ...
            <div>
                ...
                <input 
                    ...
                    id="telefono" 
                    name="telefono" 
                    value="{{ old('telefono', $usuarioAdmin->telefono) }}" 
            ...
            <div>
                ...
                >
                    ...
                    <option value="CC" {{ old('tipo_documento', $usuarioAdmin->tipo_documento) == 'CC' ? 'selected' : '' }}>Cédula de Ciudadanía</option>
                    <option value="CE" {{ old('tipo_documento', $usuarioAdmin->tipo_documento) == 'CE' ? 'selected' : '' }}>Cédula de Extranjería</option>
                    <option value="PA" {{ old('tipo_documento', $usuarioAdmin->tipo_documento) == 'PA' ? 'selected' : '' }}>Pasaporte</option>
                    <option value="NIT" {{ old('tipo_documento', $usuarioAdmin->tipo_documento) == 'NIT' ? 'selected' : '' }}>NIT</option>
                </select>
            ...
            <div class="flex items-center">
                <input 
                    ...
                    name="activo" 
                    value="1"
                    {{ old('activo', $usuarioAdmin->activo) ? 'checked' : '' }}
        ...
        <div class="mb-6">
            <p class="text-sm text-gray-600 mb-4">Seleccione los módulos que tendrá acceso este usuario. Se actualizarán los permisos correspondientes automáticamente.</p>
