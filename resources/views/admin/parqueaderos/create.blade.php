...
@section('title', 'Crear Parqueadero - Administrador')

@section('content')
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Crear Parqueadero</h1>
            <p class="mt-2 text-sm text-gray-600">Registra un nuevo parqueadero</p>
        </div>
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.parqueaderos.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                >
                    ...
                    <option value="comunal" {{ old('tipo') == 'comunal' ? 'selected' : '' }}>Comunal</option>
                    <option value="visitantes" {{ old('tipo') == 'visitantes' ? 'selected' : '' }}>Visitantes</option>
                </select>
                @error('tipo')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                >
                    ...
                    @foreach($residentes as $residente)
                        <option value="{{ $residente->id }}" {{ old('residente_responsable_id') == $residente->id ? 'selected' : '' }}>
