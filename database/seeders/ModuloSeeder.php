...
class ModuloSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $modulos = [
            ...
            [
                'nombre' => 'Comunicaciones de Cobranza',
                'slug' => 'comunicaciones-cobranza',
                'descripcion' => 'Gestión de comunicaciones automatizadas de cobranza por email y WhatsApp.',
                'icono' => 'mail',
                'ruta' => '/admin/comunicaciones-cobranza',
                'activo' => true,
                'requiere_configuracion' => true,
                'orden' => 28,
                'configuracion_default' => [
